...
public class MusicListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null)
        {
            ...
            viewHolder.musicTitle = (TextView) convertView.findViewById(R.id.mTitle);
            viewHolder.musicArtist = (TextView) convertView.findViewById(R.id.mArtist);
            viewHolder.musicAlbum = (TextView) convertView.findViewById(R.id.mAlbum);
            viewHolder.musicDuration=(TextView)convertView.findViewById(R.id.mDuration);
        ...
        viewHolder.musicAlbum.setText(mp3Info.getAlbum());
